...
# Calculate the average number of SNPs
sum=0
...
echo "Average Number of SNPs: $average" >> filtered_vcf/snps.txt

bcftools merge --threads ${threads} -Ob 22D*.vcf.gz -o severe_covid_merged_allchr.bcf

python scripts/lib/snps.py
